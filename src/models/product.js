...
const productSchemaValidation = [
	body('name').notEmpty().withMessage('El nombre el producto es obligatorio'),
	...
	body('categoryId').isMongoId().withMessage('ObjectId invalida'),
	body('imgProduct')
		.custom((value, { req }) => req.file)
		.withMessage('la imagen es obligatoria')
		.custom((value, { req }) => validateImage(req.file.mimetype))
		.withMessage(
			'Debe incluir una imagen en los formatos permitidos: ' +
				Object.values(IMAGE_TYPES).join('/')
		),
]
